...
\data{11/05/2016} % data da aprovação
...
%
\CDU{536.21} \areas{1.Desenvolvimento de Software  2. Tecnologia.}
\npaginas{93}  % total de páginas do trabalho

%------Nomes do Orientador, 1o. Examinador e 2o.
\orientador{Francisco Paulo de Freitas Neto}
\abrevttorientador{Prof. Msc}
\examinadorum{Alvaro Magnum Barbosa Neto}
\examinadordois{Ricardo de Sousa Job}
...
Apesar de existirem algums problemas com o uso do e-commerce, os consumidores virtuais demonstram altos índices de intenção de compra. Segundo \citeonline{webshoppers} essa intenção de compra significa dizer que os clientes continuam buscando e acima de tudo usando o comércio eletrônico. 

Os principais problemas citados por \citeonline{da2013crescimento} sobre o comércio eletrônico são: segurança --- pois ao realizar uma compra, o cliente precisa informar seus dados pessoais, números de cartões de crétito e até senhas; falhas no sistema; confiabilidade --- existe o risco tanto para as organizações como para os clientes de não saber a identidade real de quem está do outro lado do computador; e entrega --- devido às más condições de vários tipos de transporte, entretanto essa entrega necessita ser rápida e a um custo viável; 
...
\section{Sistemas de Gerenciamento de Conteúdo} % (fold)
\label{sec:cms}
