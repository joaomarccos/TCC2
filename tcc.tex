...
\chapter{Sudo Loja - \textit\small{Ainda não revisado}} % (fold)
\label{cha:sudo_loja}
...
\hline
TA4 & Dado que retornei a uma seção de menu de personalizações já alterada, a mesma deve carregar as preferencias alteriormente salvas.  & Finalizado\\
\hline
...
\multicolumn{2}{|c|}{Testes de aceitação} & Status\\	
\hline
TA1 & Dado que estou na página de cadastro, ao informar email e senha corretos devo ser redirecionado para a página principal da loja & Finalizado\\
\hline
TA2 & Quando clicar no bõtão ``sair'' minha seção seja encerrada e devo ser redirecionado para a página inicial  & Finalizado\\
\hline
...
\hline
TA3 & Dado que sou um lojista logado no sistema, ao perceber uma nova pergunta poderei responde-la e a resposta deve aparecer junto a pergunta feita pelo usuário na página do produto   & Finalizado\\
\hline
\end{longtable}
...
\hline
T4 & Adicionar campo peso ao produto, e borão para definir se este é passível ao cálculo de frete ou não & João Marcos & 2 & 1 & Finalizado\\
\hline
...
\hline
TA4 & Dado que submeti um CEP para simulação do valor de entrega, e este seja válido, quando os produtos não possuirem frete, a palavra ``Grátis'' é exibida no local onde seria exibido o valor do frete  & Finalizado\\
\hline
...
\hline
T3 & Criar formulário para inserção e modificação das imagems de um produto & João Marcos & 3 & 1 & Finalizado\\
\hline
...
\multicolumn{2}{|c|}{Testes de aceitação} & Status\\	
\hline
TA1 & Dado que estou na página do prduto, a galeria deve ser exibida com suas imagens & Finalizado\\
\hline
...
\hline
T3 & Criar formulário para inserção de dados de pagamento no painel admnistrativo & João Marcos & 2 & 1 & Finalizado\\
\hline
T4 & Criar página para visualização de pedidos para lojistas e clientes & João Marcos & 5 & 4 & Finalizado\\
\hline
T5 & Criar formulário para alteração de status de pedido no painel adminstrativo & João Marcos & 2 & 2 & Finalizado\\
\hline
\end{longtable}
...
\hline
TA5 & Dado que estou na pagina de gerenciamento de pedidos e sou um lojista, quando um pedido for estraviado, poderei informar ao cliente  & Finalizado\\
\hline
\end{longtable}
